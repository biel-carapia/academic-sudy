class Filhos: 
    ...
    def imprimir_percurso_pos_ordem(self):  
        """
        Percorre a árvore em pré ordem (esquerda, direita, vértice) e imprime o dado do vértice 
        :return: None 
        """ 
        for vertice in self._vertices: 
...
class Vertice: 
    ...
    def imprimir_percurso_pre_ordem(self): 
        """
        Percorre a árvore em pré ordem (vértice, filhos) e imprime o dado do vértice 
        :return: None 
        """ 
        # imprime o dado do vértice 
        print(self) 
    ...
    def imprimir_percurso_pos_ordem(self): 
        """
        Percorre a árvore em pré ordem (filhos, vértice) e imprime o dado do vértice 
        :return: None 
        """ 
        if self.filhos: 
            # recursividade: executa o mesmo atributo para seus filhos 
